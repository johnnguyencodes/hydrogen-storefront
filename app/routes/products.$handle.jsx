...
export async function loader({ params, context, request }) {
    ...
    const shop = { "primaryDomain": {
        "url": "https://www.johnnyfiive.com"
    }}
...
export default function ProductHandle() {
    ...
    console.log("selectedVariant data", selectedVariant);

    return (
        <section className="grid w-full gap-4 px-6 md:gap-8 md:px-8 lg:px-12">
            <div className="grid items-start gap-6 lg:gap-20 md:grid-cols-2 lg:grid-cols-3">
                <div className="grid md:grid-flow-row md:p-0 md:overflow-x-hidden md:grid-cols-2 md:w-full lg:col-span-2">
                    <div className="md:col-span-2 span-center card-image aspect-square md:w-full w-[80vw] shadow rounded"></div>
                    <Image
            ...
            <div className="md:sticky md:mx-auto max-w-xl grid gap-2 p-0 md:p-6 md:px-0 md:max-w-[24rem] top-[6rem] lg:top-[8rem] xl:top-[10rem]">
